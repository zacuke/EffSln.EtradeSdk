...
namespace EffSln.EtradeSdk.Authorization.RenewAccessToken
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class RenewAccessTokenClient 
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public RenewAccessTokenClient(System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// </summary>
        /// <remarks>
        /// Renews the OAuth access token. If the access token has been inactive for two hours, it must be reactivated using this endpoint.
        /// </remarks>
        ...
        /// <param name="oauth_nonce">A nonce: roughly, an arbitrary or random value that cannot be used again with the same timestamp.</param>
        ...
        /// <param name="oauth_token">The consumer’s access token to be renewed.</param>
        ...
        public virtual async System.Threading.Tasks.Task<string> TokenAsync(string oauth_consumer_key, string oauth_timestamp, string oauth_nonce, Oauth_signature_method oauth_signature_method, string oauth_signature, string oauth_token, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "oauth/renew_access_token"
                    urlBuilder_.Append("oauth/renew_access_token");
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<Response>("Issue with the input.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            ...
                            throw new ApiException<Response2>("Unexpected server error.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
