...
namespace EffSln.EtradeSdk.Authorization.Authorize
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <param name="oauth_token">The consumer’s request token.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task AuthorizeAsync(string oauth_consumer_key, string oauth_token)
        {
            return AuthorizeAsync(oauth_consumer_key, oauth_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="oauth_token">The consumer’s request token.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task AuthorizeAsync(string oauth_consumer_key, string oauth_token, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "e/t/etws/authorize"
                    urlBuilder_.Append("e/t/etws/authorize");
                    ...
                    try
                    {
                        ...
                        if (status_ == 302)
                        {
                            ...
                            throw new ApiException<string>("Redirect to the authorization URL for user authorization.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<Response>("There is an issue with user input.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            ...
                            throw new ApiException<Response2>("An unexpected error occurred on the server.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
    ...
    {
        /// <summary>
        /// Verification code provided by E*TRADE after successful authorization.
        /// </summary>

        [System.Text.Json.Serialization.JsonPropertyName("oauth_verifier")]
        public System.Uri Oauth_verifier { get; set; }
